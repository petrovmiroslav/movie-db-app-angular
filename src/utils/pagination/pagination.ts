...
export const paginationDtoMapper = <T, R>(
  dto: PaginationDto<T>,
  resultsMapper: (resultDto: PaginationDto<T>['results']) => PaginationResponse<R>['results'],
...
export const getNextPageNumber = <Data extends unknown>(
  params: PaginationResponse<Data> | undefined,
): number | undefined => {
