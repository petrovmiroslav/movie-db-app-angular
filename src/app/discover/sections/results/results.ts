...
import { DiscoverMovieApiParams } from '../../../../features/movies/api/discoverMovieApi/types';
...
export class Results {
  ...
  protected readonly queryParam = signal<Params>({});
  ...
  protected readonly useMoviesQueryParams = computed<DiscoverMovieApiParams | null>(() => {
    const queryParam = this.queryParam() as DiscoverMovieApiParams;
    return queryParam ? { ...queryParam } : null;
  });

  protected readonly moviesQuery = useDiscoverMovieInfiniteListQuery(this.http)(
